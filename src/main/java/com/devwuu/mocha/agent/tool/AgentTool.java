 ...
 * <p>SDK 무관 도메인 타입 — 드라이버({@link OpenAiAgentClient})가 정의를 벤더 tool 스키마로 변환하고,
 * 모델의 tool 호출을 {@link Executor}로 디스패치한다. tool 구현체(AgentToolkit — TΔ5·TΔ6)가
 ...
 */
public record AgentTool(String name, String description, String parametersSchema, Executor executor) {
