 ...
 * enum 위반(V-5)을 역직렬화 예외가 아니라 검증 진입점({@code RecordProposalValidator})의
 * <b>사유 있는 거부</b>로 다루기 위한 계약 타입이다 (ref: specs/coffee-note-agent/data-model.md#3.3, plan#ADR-45).
 *
