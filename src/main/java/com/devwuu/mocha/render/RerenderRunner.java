 ...
 * <p>렌더 실패로 데이터가 상하는 일은 없으므로(ADR-1), site/를 지운 뒤나 스키마/디자인을 바꾼 뒤 수동 복구용으로 쓴다.
...
public class RerenderRunner implements ApplicationRunner {
    ...
    public RerenderRunner(SiteRenderer siteRenderer, ConfigurableApplicationContext context) {
